...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/davixde/osm-italy-routing-labels/.github/workflows/build.yml?style=for-the-badge&label=Action&maxAge=0)](https://github.com/davixde/osm-italy-routing-labels/actions)
